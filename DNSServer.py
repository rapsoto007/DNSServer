...
def encrypt_with_aes(input_string, password, salt):
    ...
    return encrypted_data.decode('utf-8')   # Return string version for TXT
...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (encrypted_value,),  # encrypted token as a tuple of one string
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    # Fix: send TXT record as list of bytes so client receives correct token without quotes
                    rdata_list.append(TXT(dns.rdataclass.IN, dns.rdatatype.TXT, [answer_data[0].encode('utf-8')]))
                else:
